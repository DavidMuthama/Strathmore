...
df = load_df()
df_grouped = df.groupby(['year', 'sex'])[['total_inactive_population', 'total_unemployed_population', 'total_employed_population','Basic_unemployment','Intermediate_unemployment','Advanced_unemployment','age']].sum().reset_index()
...
fig8=px.bar(df_grouped,x='age',y='Basic_unemployment',color='sex',color_discrete_map={'male':'blue', 'female':'pink'},title='sum of unemployment by basic ed')
